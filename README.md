...
* RAM: 64 Кб
* ROM: 6 Кб
* Графические режимы: ч/б 480x224, 4-х цветная с палитрой из 64 цветов с разрешением 240x224.
* Текстовые режимы: 60x28 ч/б, 30x28 4-х цветный
* Звук: На таймере К580ВИ53


Проект разработан в среде EasyEDA. Схема воссоздана по сканам схемы из инструкции из [темы форума](https://www.phantom.sannata.org/viewtopic.php?f=23&t=6841).
